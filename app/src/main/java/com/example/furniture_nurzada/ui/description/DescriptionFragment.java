package com.example.furniture_nurzada.ui.description;
...
import com.example.furniture_nurzada.databinding.FragmentDescriptionBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (d_list != null) {
            ...
            Toast.makeText(requireActivity(),
                    "Вы не выбрали товар", Toast.LENGTH_SHORT).show();
        }
